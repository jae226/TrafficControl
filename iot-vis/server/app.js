...
app.use('/api/data', proxy2('/api/data', {
  target: 'https://iot-data.run.aws-usw02-pr.ice.predix.io',
  agent: https.globalAgent,
  headers: {
    host: 'iot-data.run.aws-usw02-pr.ice.predix.io'
  },
  pathRewrite: {
    '^/api/data': '/api/dataPoints'
  }
}));
